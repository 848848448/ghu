...
<body>
  ...
  <script>
    ...
    hydrateIcons(); checkStatus(); loadMe(); sendPresence(); setInterval(sendPresence, 25000); setInterval(function(){ if(!ME.admin){ loadMe(); } }, 30000); setInterval(refreshNew, 60000); loadConfig().then(function(){ home(); });
  </script>
</body>
</html>`;
